    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                Link("GitHub Repository", destination: URL(string: "https://github.com/yourusername/gitpeek")!)
                Link("Report an Issue", destination: URL(string: "https://github.com/yourusername/gitpeek/issues")!)
                Link("License: MIT", destination: URL(string: "https://github.com/yourusername/gitpeek/blob/main/LICENSE")!)
            }
